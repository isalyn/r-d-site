...
var pjt = require('./pjtconfig.json');
...
gulp.task('archive:src', function () {
    return gulp.src('src/*')
        .pipe(zip(`${pjt.name}_v${pjt.version}_${time}_dev.zip`))
        .pipe(gulp.dest('archive/'));
});

gulp.task('archive:dist', ['build'], function () {
    return gulp.src('dist/**/*')
        .pipe(zip(`${pjt.name}_v${pjt.version}_${time}.zip`))
        .pipe(gulp.dest('archive/'));
});
...
gulp.task('default', ['html', 'browser', 'watch']);
